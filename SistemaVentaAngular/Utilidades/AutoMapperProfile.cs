        ...
        CreateMap<Producto, ProductoDTO>()
            ...
            CreateMap<DetalleVenta, DetalleVentaDTO>()
                ...
                .ForMember(destino =>
                    ...
                    destino.Cost,
                    opt => opt.MapFrom(origen => Convert.ToString(origen.Cost.Value, new CultureInfo("es-PE")))
                ).ForMember(destino =>
                    destino.CantidadML,
            ...
            CreateMap<DetalleVentaDTO, DetalleVenta>()
                ...
                .ForMember(destino =>
                    destino.Cost,
                    opt => opt.MapFrom(origen => Convert.ToDecimal(origen.Cost, new CultureInfo("es-PE")))
                )
                .ForMember(destino =>
                    destino.CantidadML,
            ...
            CreateMap<DetalleVentasCredito, VentasCreditReporteDTO>()
                ...
                .ForMember(destino =>
                    ...
                    destino.Cost,
                    opt => opt.MapFrom(origen => Convert.ToString(origen.Cost, new CultureInfo("es-PE")))
                )
                .ForMember(destino =>
                    destino.Total,
